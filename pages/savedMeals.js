...
function SavedMeals() {
  ...
  return (
    <div className='pt-20'>
      <h1 className='text-center text-4xl text-red-600 pt-20 '>Saved Recipe List</h1>
  ...
  <Link href={`/meals/${data.idMeal}`}>
    <div className='flex justify-center p-5'>
      <h1 className='p-5 border-4 border-red-600 rounded-3xl text-2xl text-red-400 hover:text-red-600 transition duration-150' variant="secondary" >{data.strMeal}</h1>
    </div>
  </Link>
</div>
          );
